...
public class PullSensorConfig
{
    ...
    public final static String SENSE_WINDOW_LENGTH_MILLIS = "50000";
    ...
    public final static String NUMBER_OF_SENSE_CYCLES = "1";
	...
	// class
    public final static String SENSE_WINDOW_LENGTH_PER_CYCLE_MILLIS = "50000";

	// this is the sleep interval between two consecutive sensor samplings
    public final static String POST_SENSE_SLEEP_LENGTH_MILLIS = "50000";

	// whether adaptive sensing is enabled for all sensors
    public final static String ADAPTIVE_SENSING_ENABLED = "enabled";
